...
const OurServices = () => {
  ...
  return (
    <section className="scroll-mt-20 py-10 px-4 md:px-10 bg-gray-100">
      <div className="mx-auto max-w-7xl">
        ...
        >
          {/* Accordion */}
          <div className="flex flex-col bg-white rounded-md shadow-sm p-4 overflow-y-auto">
            {Accordiondata.map((item, index) => (
              ...
              >
                ...
                {/* Green underline */}
                <div
                  className={`absolute bottom-0 left-0 w-1/2 h-[1px] rounded-full ${
                    index === activeIndex ? "bg-green-500" : "bg-transparent"
                  }`}
                />
              </div>
            ))}
          ...
          {/* Image */}
          <div className="rounded-md shadow-md overflow-hidden flex">
            <img
